...
OUT_BINS="libpt_matc.so pt_matc_test"

# flex bison
rm -rf ${MY_DIR}/../../src/pt_matc_mdl_scanner_lex.inl
flex -X -o ${MY_DIR}/../../src/pt_matc_mdl_scanner_lex.inl ${MY_DIR}/../../src/pt_matc_mdl_scanner_lex.l   
rm -rf ${MY_DIR}/../../src/pt_matc_mdl_parser_yacc.inl
bison -y -o ${MY_DIR}/../../src/pt_matc_mdl_parser_yacc.inl -p mdl_yy ${MY_DIR}/../../src/pt_matc_mdl_parser_yacc.y -L C 
