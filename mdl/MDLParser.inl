...
#line 148 "mdl/MDLParser.inl" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 24 "mdl/MDLParser.y" /* yacc.c:359  */
...
#line 155 "mdl/MDLParser.inl" /* yacc.c:359  */
...
static const char *const yytname[] =
    {
        "$end", "error", "$undefined", "MDL", "IMPORT", "IDENT",
        "INTEGER_LITERAL", "FLOATING_LITERAL", "';'", "$accept", "mdl",
        "mdl_version", "import_declaration_closure", "import_declaration",
...
static const yytype_uint8 yystos[] =
    {
        0, 3, 10, 11, 7, 0, 12, 8, 4, 13,
        5, 14, 15, 8};

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
    {
        0, 9, 10, 11, 12, 12, 13, 14, 15};
...
yy_reduce_print(yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, void *pUserData, void *pScanner)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
  {
    ...
    yy_symbol_print(stderr,
                    ...
                    &(yyvsp[(yyi + 1) - (yynrhs)]), &(yylsp[(yyi + 1) - (yynrhs)]), pUserData, pScanner);
    YYFPRINTF(stderr, "\n");
  }
}
...
#line 1329 "mdl/MDLParser.inl" /* yacc.c:1646  */
  default:
    break;
  }
