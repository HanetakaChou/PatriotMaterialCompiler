...
inline parser::syntax_error::syntax_error(const std::string &m)
    : std::runtime_error(m)
{
}
...
template <typename Base>
inline parser::basic_symbol<Base>::basic_symbol(typename Base::kind_type t, const semantic_type &v)
    : Base(t), value(v)
{
}
...
inline parser::symbol_number_type
...
inline parser::token_number_type
